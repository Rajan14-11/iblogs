        ...
        <Container>
          <Row className="align-items-center">
            <Col md={6} className="text-center pt-5">
              ...
              >
                iBlogs - Share your thoughts with world
              </h2>
              <p>
                iBlogs is an open-source blog app. Capture your thoughts and
          ...
          <Row className="align-items-center">
            ...
            <Col md={6}>
              <h2 className="text-end">
                <strong>Introducing iBlogs</strong>
              </h2>
              <p className="my-4">
        ...
        <Container>
          <Row className="text-center">
            ...
            <Col md={4}>
              ...
              <p>
                As it is cloud based application, you can access your blogs from
                anywhere.
              </p>
            </Col>
            <Col md={4}>
              ...
              <h3>100% secure</h3>
              <p>
                Uses End-To-End Encryption (E2EE) to secure your blogs and
                ensure no-one but only yourself can access them.
              </p>
            </Col>
          </Row>
        </Container>
